...
const Second = () => {
    return (
        <div className="second-container-icon-wireless">
            ...
            <div className="second-tile">
                ...
                <h1 className="second-text">10 Hours of Battery Life</h1>
            </div>
            <div className="second-tile">
                <FlashOnOutlinedIcon className="second-icon" />
                <h1 className="second-text">No-Slip Headband</h1>
            </div>
            <div className="second-tile">
            ...
            <div className="second-tile">
                ...
                <h1 className="second-text">TapTech™ Call and Track Control</h1>
            </div>
            <div className="second-tile">
